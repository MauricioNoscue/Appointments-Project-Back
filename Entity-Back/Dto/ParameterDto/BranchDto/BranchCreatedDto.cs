...
public class BranchCreatedDto
{
    ...
    [StringLength(50, MinimumLength = 3, ErrorMessage = "El nombre debe tener entre 3 y 100 caracteres")]
    public string Name { get; set; }

    [Required(ErrorMessage = "El correo electrónico es obligatorio")]
    [EmailAddress(ErrorMessage = "El correo no tiene un formato válido")]
    [StringLength(20, ErrorMessage = "El correo no puede superar los 100 caracteres")]
    public string Email { get; set; }

    [Required(ErrorMessage = "El número de teléfono es obligatorio")]
    [Phone(ErrorMessage = "El teléfono no tiene un formato válido")]
    [StringLength(10, ErrorMessage = "El teléfono no puede superar los 20 caracteres")]
